...
from context.context import FSMreserved
...
@dp.message_handler(state=FSMreserved.time)
...
@dp.message_handler(state=FSMreserved.people)
...
@dp.message_handler(content_types=ContentType.CONTACT, state=FSMreserved.phone_number)
...
@dp.message_handler(state=FSMreserved.phone_number)
