...
async def start_loyal(message: types.Message):
    ...
    if not check_user:
        await message.answer("Добро пожаловать в мир удовольствий и выгод! Рады представить вам нашу карту лояльности "
                             ...
                             "5% скидка при регистрации. С момента активации вашей карты лояльности вы экономите с "
                             "каждым заказом, наслаждаясь изысканными блюдами по особенно привлекательной цене.\n\n"
